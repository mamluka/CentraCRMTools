...
old_dead_leads = dead_leads.select do |lead|
  !lead.custom_data.nil? && !lead.custom_data.dead_status_assigned_date_c.nil? && lead.custom_data.dead_status_assigned_date_c < 7.days.ago && lead.emails.any? && !lead.do_not_email && lead.custom_data.dead_client_email_sent_c.nil? && lead.custom_data.not_billable_c == true
end
